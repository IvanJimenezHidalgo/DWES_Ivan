        ...
        switch (request.getParameter("op")) {
            case "update":
                try {
                    ...
                    libro = new Libro();
                    libro.setIdLibro(Integer.parseInt(request.getParameter("id1")));
                    libro.setTitulo(request.getParameter("titulo1"));
                    libros.add(libro);
                    libro = new Libro();
                    libro.setIdLibro(Integer.parseInt(request.getParameter("id2")));
                    libro.setTitulo(request.getParameter("titulo2"));
                    libros.add(libro);
                    libro = new Libro();
                    libro.setIdLibro(Integer.parseInt(request.getParameter("id3")));
